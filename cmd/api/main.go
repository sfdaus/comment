...
func main() {
	...
	commentRepo := pgsqlRepository.NewPgsqlCommentRepository(dbInstance)
	...
	commentUC := usecase.NewCommentUsecase(commentRepo, redisRepo, s3Repo, ctxTimeout)
	...
	httpDelivery.NewCommentHandler(e, appMiddleware, commentUC)
